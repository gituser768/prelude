;; DH- Made some changes for my own usages. This was originally written by
;; Bobe Newell
...
;; 2016-07-18 0.14 Add poetry-find-rhyme-val which returns the rhyming result
;;
...
(defun poetry-find-rhyme-val (word)
  "Simple interface to rhyme package"
  (interactive "sWord: ")
  (setq poetry-rhyme
        (replace-regexp-in-string "\r?\n$" " "
